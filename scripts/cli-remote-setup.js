...
// --- Validation ---
const VALID_METHODS = ['vpn', 'proxy', 'direct', 'cloudflare', 'disable'];
...
try {
    ...
    if (method === 'vpn') {
        ...
        console.log('Method: Cloudflare Quick Share');
        console.log('Status: Ready for Cloudflare Tunnel');
        console.log('Action: Run scripts/share-website.js to get your public link.');
