                ...
                <div className="px-4 py-3 flex flex-col md:flex-row items-center justify-between gap-4">
                    ...
                    <div className="flex items-center gap-2">
                        <button 
                            ...
                            className="bg-primary hover:bg-primary/90 text-primary-foreground px-5 py-1.5 rounded-md text-[10px] font-bold tracking-tight disabled:opacity-30 disabled:grayscale transition-all shadow-sm flex items-center gap-2"
                        >
