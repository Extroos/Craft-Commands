                    ...
                    {step === 4 && (
                        <div className="space-y-3 text-center py-4">
                            ...
                            <div>
                                ...
                                {method === 'direct' && (
                                    <div className="mt-3 p-3 bg-blue-500/5 border border-blue-500/20 rounded-lg text-left">
                                        <p className="text-xs font-bold text-blue-600 uppercase mb-1">Router Setup Help</p>
                                        <p className="text-[11px] text-muted-foreground leading-relaxed">
                                            For direct access, you must forward ports in your router settings to this machine's local IP:
                                            <span className="block mt-1 font-mono text-foreground font-bold text-center bg-secondary py-1 rounded">
                                                {/* We don't have systemStatus here easily, so we call a quick check or just use common sense */}
                                                Detected shortly... (Check Dashboard)
                                            </span>
                                        </p>
                                    </div>
                                )}
