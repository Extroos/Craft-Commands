...
const Login: React.FC<LoginProps> = ({ onLogin, onViewStatus }) => {
    ...
    return (
        <div className="min-h-screen flex flex-col items-center justify-center relative overflow-hidden p-6 font-sans">
            ...
            >
                ...
                <motion.div 
                    variants={{
                        ...
                        visible: { opacity: 1, scale: 1, y: 0, transition: { type: 'spring', damping: 20, stiffness: 150 } }
                    }}
                    className="glass-morphism border border-border rounded-xl shadow-2xl p-6 relative overflow-hidden"
                >
                ...
                <motion.div 
                    ...
                    className="mt-2 bg-card border border-border rounded-lg p-3 flex gap-4 shadow-sm"
                >
                ...
                <motion.a 
                    ...
                    className="text-center text-[9px] font-mono tracking-[0.3em] uppercase mix-blend-screen hover:text-primary transition-all cursor-pointer"
                >
